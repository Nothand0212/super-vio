...
void ROSTool::publishPointCloud( const std::vector<Eigen::Vector3d>& points, const Eigen::Matrix3d& rotation, const Eigen::Vector3d& translation, double time_stamp )
{
